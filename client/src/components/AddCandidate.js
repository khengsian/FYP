...
class AddCandidate extends Component {
  ...
  addCandidate = async () => {
    ...
    var result2 = this.state.party.match(patt1);
    var result3 = this.state.constituency.match(patt2);
    var result4 = this.state.manifesto.match(patt3);

    if (this.state.name === '' || this.state.party === '' || this.state.constituency === ''|| this.state.manifesto ==='')
    { 
       alert("Please key in all the information!!");  	
    }
     else if(result === null || result2 === null || result3 === null || result4 === null){
